...
/**
 * A Server is a server for a "netgame".  When a Server is created, it will
...
public class Server {
    ...
    /**
     * Creates a Server listening on a specified port, and starts a thread for
     ...
     * @param auto keeps the autoreset working.
     */
        ...
        private class SendThread extends Thread {
            public void run() {
                try {
                    ...
                    String handle = (String) in.readObject(); // first input must be "Hello Server"
                    if (!"Hello Server".equals(handle))
                        throw new GameException("Incorrect hello string received from client.");
